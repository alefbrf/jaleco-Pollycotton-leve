...
document.getElementById('basebase6').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#basebase6 + label span")).backgroundColor;
  document.querySelectorAll(".base").forEach(v => v.style.fill = corselecionada);
  document.getElementById('CB').style.backgroundColor = corselecionada;
});
document.getElementById('basebase7').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#basebase7 + label span")).backgroundColor;
  document.querySelectorAll(".base").forEach(v => v.style.fill = corselecionada);
  document.getElementById('CB').style.backgroundColor = corselecionada;
});
document.getElementById('basebase8').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#basebase8 + label span")).backgroundColor;
  document.querySelectorAll(".base").forEach(v => v.style.fill = corselecionada);
  document.getElementById('CB').style.backgroundColor = corselecionada;
});
document.getElementById('basebase9').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#basebase9 + label span")).backgroundColor;
  document.querySelectorAll(".base").forEach(v => v.style.fill = corselecionada);
  document.getElementById('CB').style.backgroundColor = corselecionada;
});
...
document.getElementById('carcelacarcela6').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#carcelacarcela6 + label span")).backgroundColor;
    document.querySelectorAll(".carcela").forEach(v => v.style.fill = corselecionada);
    document.getElementById('BT').style.backgroundColor = corselecionada;
});
document.getElementById('carcelacarcela7').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#carcelacarcela7 + label span")).backgroundColor;
    document.querySelectorAll(".carcela").forEach(v => v.style.fill = corselecionada);
    document.getElementById('BT').style.backgroundColor = corselecionada;
});
document.getElementById('carcelacarcela8').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#carcelacarcela8 + label span")).backgroundColor;
    document.querySelectorAll(".carcela").forEach(v => v.style.fill = corselecionada);
    document.getElementById('BT').style.backgroundColor = corselecionada;
});
document.getElementById('carcelacarcela9').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#carcelacarcela9 + label span")).backgroundColor;
    document.querySelectorAll(".carcela").forEach(v => v.style.fill = corselecionada);
    document.getElementById('BT').style.backgroundColor = corselecionada;
});
...
document.getElementById('golagola6').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#golagola6 + label span")).backgroundColor;
    document.querySelectorAll(".gola").forEach(v => v.style.fill = corselecionada);
    document.getElementById('ge').style.backgroundColor = corselecionada;
});
document.getElementById('golagola7').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#golagola7 + label span")).backgroundColor;
    document.querySelectorAll(".gola").forEach(v => v.style.fill = corselecionada);
    document.getElementById('ge').style.backgroundColor = corselecionada;
});
document.getElementById('golagola8').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#golagola8 + label span")).backgroundColor;
    document.querySelectorAll(".gola").forEach(v => v.style.fill = corselecionada);
    document.getElementById('ge').style.backgroundColor = corselecionada;
});
document.getElementById('golagola9').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#golagola9 + label span")).backgroundColor;
    document.querySelectorAll(".gola").forEach(v => v.style.fill = corselecionada);
    document.getElementById('ge').style.backgroundColor = corselecionada;
});
